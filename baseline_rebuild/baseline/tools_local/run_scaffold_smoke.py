...
JOBS = [
    {
        "model": "neims",
        "repo": SOURCE,
        "source_config": load_locked_config(BASE, "neims", "scaffold", 42),
    },
    {
        "model": "massformer",
        "repo": SOURCE,
        "source_config": load_locked_config(BASE, "massformer", "scaffold", 42),
    },
    {
        "model": "fragnnet_d3",
        "repo": SOURCE,
        "source_config": load_locked_config(BASE, "fragnnet_d3", "scaffold", 42),
    },
    {
        "model": "iceberg",
        "repo": SOURCE,
        "source_config": load_locked_config(BASE, "iceberg", "scaffold", 42),
    },
]
