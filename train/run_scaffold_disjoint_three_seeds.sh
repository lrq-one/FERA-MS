...
print()
print("=" * 100)
print("SCAFFOLD-DISJOINT THREE-SEED RAW RESULTS")
print("=" * 100)
print(raw.to_string(index=False))

print()
print("=" * 100)
print("SCAFFOLD-DISJOINT THREE-SEED SUMMARY")
print("=" * 100)
...
main() {
    ...
    export MS2_SPLIT_DP="$SCAFFOLD_SPLIT"
    ...
    do
        ...
        run_logged \
            "SEED_${SEED}_GLOBAL_ACE_CONTROL" \
            "$SEED_DIR/logs/global_ace_control.log" \
            python -u \
            train/train.py \
            control
...
print(
    "BASE_RETAINED_CONTROL_GLOBAL_ACE_CONTROL_SEED_AUDIT_OK"
)
PY
    ...
    echo
    echo "================================================================================================"
    echo "ALL THREE SCAFFOLD-DISJOINT RUNS FINISHED"
    echo "================================================================================================"
