...
def main():
    ...
    # Must match loaded collision_energy_response_refinement/formula_composition_refinement architecture.
    ...
    cfg = energy_response.override_cfg_collision_energy_response(cfg, args)
